...
import { switchLoginToSignup, toggleLoginPopup, switchLoginToForgetPassword } from '../../../store/slices/PopupSlice.ts';
          ...
          <div className="flex flex-col items-start w-full gap-11">
            ...
            <div className="flex flex-col w-full gap-3">
              ...
              <div className="flex justify-end w-full">
                <button
                  type="button"
                  onClick={() => dispatch(switchLoginToForgetPassword())}
                  className="text-sm font-medium text-theme1 hover:text-theme1/80"
                >
                  Forgot Password?
                </button>
              </div>
