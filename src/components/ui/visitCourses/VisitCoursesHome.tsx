...
const VisitCoursesHome = () => {
    ...
    return (
        <section className="relative w-full py-24 overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-64 bg-orange-50 opacity-50 -skew-y-6 transform-gpu -translate-y-32"></div>
            <div className="absolute top-0 right-0 hidden w-96 h-96 bg-orange-100 rounded-full opacity-20 -translate-x-1/4 -translate-y-1/2 lg:block"></div>
            <div className="absolute bottom-0 left-0 hidden w-64 h-64 bg-orange-100 rounded-full opacity-20 translate-x-1/4 translate-y-1/2 lg:block"></div>
            ...
            <div className="container relative z-10 px-4 mx-auto md:px-8 max-w-7xl">
                ...
                > */}
                    {/* <div className="p-10 overflow-hidden rounded-2xl bg-gradient-to-r from-orange-500 to-amber-600 relative"> */}
                        {/* CTA Background Elements */}
                        {/* <div className="absolute top-0 right-0 w-40 h-40 bg-orange-400 rounded-full opacity-20 -translate-y-1/2 translate-x-1/4"></div>
                        <div className="absolute bottom-0 left-0 w-40 h-40 bg-amber-400 rounded-full opacity-20 translate-y-1/2 -translate-x-1/4"></div> */}
