            ...
            <div className="flex flex-wrap justify-center gap-3">
                {pfEsiOptions.map((option, index) => (
                    ...
                    >
                        ...
                        <button onClick={() => navigate(`/practice/pf-esi/${option.slug}`)} className="flex items-center m-5 text-gray-700 bg-white border border-gray-400 btn hover:bg-gray-100">
