        ...
        <div className="flex flex-col items-center px-10 pt-5 pb-20">
            ...
            <div className="w-full py-10 hero">
                <div className="text-center">
                    <h1 className="text-4xl font-bold">ITR Forms</h1>
                    <p className="mt-2 text-lg">Select a form to proceed</p>
                </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-3">
                {itrOptions.map((option, index) => (
                    ...
                    >
                        ...
                        <button onClick={() => navigate(`/practice/itr/login/${option.slug}`)} className="flex items-center m-5 text-gray-700 bg-white border border-gray-400 btn hover:bg-gray-100">
            ...
            {/* Back Button */}
            <button onClick={() => navigate("/practice/itr")} className="mt-6 btn btn-outline">
                ⬅ Back to ITR Services
            </button>
        </div>
    );
};

export default ItrLogin; 