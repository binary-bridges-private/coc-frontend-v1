...
const Gstr1 = () => {
    ...
    // State to track if period is selected
    const [periodSelected, setPeriodSelected] = useState(false);

    // Financial years options (you can generate these dynamically)
    ...
    // Period options (monthly or quarterly based on selection)
    const periods = [
    ...
    const handlePeriodSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (period.financialYear && period.quarter && period.period) {
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setPeriod({...period, financialYear: e.target.value})}
                                    required
                                >
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setPeriod({...period, quarter: e.target.value})}
                                    required
                                >
                ...
                <div className="w-full py-10 hero">
                    <div className="text-center">
                        ...
                        <div className="p-4 mt-4 bg-blue-100 rounded-lg">
                            <p className="font-semibold">Selected Period: {period.period}, {period.quarter}, FY {period.financialYear}</p>
                            <button 
            ...
            {periodSelected && open > 0 && (
                <div className="w-[60%] mb-10 p-6 mx-auto bg-white rounded-lg shadow-lg">
                    <div className="mb-4 text-sm text-gray-600">
                        Filing for: {period.period}, {period.quarter}, FY {period.financialYear}
                    </div>
