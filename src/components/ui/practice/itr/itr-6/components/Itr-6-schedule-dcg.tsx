      ...
      >
          ...
          <div className="space-y-4">
            <div className="rounded-md border border-gray-300 bg-white p-4">
              <h4 className="mb-3 font-medium text-gray-800">
                1a. Block entitled for depreciation @ 15 per cent (Schedule DPM - 2010)
              </h4>
              <InputField
                label=""
                name="dcgPlantMachinery15Percent"
                type="number"
                placeholder="Amount"
                register={register}
                error={errors.dcgPlantMachinery15Percent?.message}
              />
            </div>

            <div className="rounded-md border border-gray-300 bg-white p-4">
              <h4 className="mb-3 font-medium text-gray-800">
                1b. Block entitled for depreciation @ 30 per cent (Schedule DPM - 2010)
              </h4>
              <InputField
                label=""
                name="dcgPlantMachinery30Percent"
                type="number"
                placeholder="Amount"
                register={register}
                error={errors.dcgPlantMachinery30Percent?.message}
              />
            </div>

            <div className="rounded-md border border-gray-300 bg-white p-4">
              <h4 className="mb-3 font-medium text-gray-800">
                1c. Block entitled for depreciation @ 40 per cent (Schedule DPM - 2010)
              </h4>
              <InputField
                label=""
                name="dcgPlantMachinery40Percent"
                type="number"
                placeholder="Amount"
                register={register}
                error={errors.dcgPlantMachinery40Percent?.message}
              />
            </div>

            <div className="rounded-md border border-gray-300 bg-white p-4">
              <h4 className="mb-3 font-medium text-gray-800">
                1d. Block entitled for depreciation @ 45 per cent (Schedule DPM - 2010)
              </h4>
              <InputField
                label=""
                name="dcgPlantMachinery45Percent"
                type="number"
                placeholder="Amount"
                register={register}
                error={errors.dcgPlantMachinery45Percent?.message}
              />
            </div>

            <div className="rounded-md bg-yellow-50 p-3 text-sm font-medium text-gray-800">
              <div className="flex justify-between">
                <span>1d. Total (1a + 1b + 1c + 1d)</span>
                <span className="font-semibold text-yellow-600">
                  {calculateTotal(
                    [
                      "dcgPlantMachinery15Percent",
                      "dcgPlantMachinery30Percent",
                      "dcgPlantMachinery40Percent",
                      "dcgPlantMachinery45Percent",
                    ],
                    watch
                  )}
                </span>
        ...
        <div className="space-y-4 rounded-lg border border-gray-200 bg-gray-50 p-5">
          ...
          <div className="space-y-4">
            <div className="rounded-md border border-gray-300 bg-white p-4">
              <h4 className="mb-3 font-medium text-gray-800">
                2a. Block entitled for depreciation @ 5 per cent (Schedule DOA - 17(i))
              </h4>
              <InputField
                label=""
                name="dcgBuilding5Percent"
                type="number"
                placeholder="Amount"
                register={register}
                error={errors.dcgBuilding5Percent?.message}
              />
            </div>

            <div className="rounded-md border border-gray-300 bg-white p-4">
              <h4 className="mb-3 font-medium text-gray-800">
                2b. Block entitled for depreciation @ 10 per cent (Schedule DOA - 17(i))
              </h4>
              <InputField
                label=""
                name="dcgBuilding10Percent"
                type="number"
                placeholder="Amount"
                register={register}
                error={errors.dcgBuilding10Percent?.message}
              />
            </div>

            <div className="rounded-md border border-gray-300 bg-white p-4">
              <h4 className="mb-3 font-medium text-gray-800">
                2c. Block entitled for depreciation @ 40 per cent (Schedule DOA - 17(i))
              </h4>
              <InputField
                label=""
                name="dcgBuilding40Percent"
                type="number"
                placeholder="Amount"
                register={register}
                error={errors.dcgBuilding40Percent?.message}
              />
            </div>

            <div className="rounded-md bg-yellow-50 p-3 text-sm font-medium text-gray-800">
              <div className="flex justify-between">
                <span>2d. Total (2a + 2b + 2c)</span>
                <span className="font-semibold text-yellow-600">
                  {calculateTotal(
                    [
                      "dcgBuilding5Percent",
                      "dcgBuilding10Percent",
                      "dcgBuilding40Percent",
                    ],
                    watch
                  )}
                </span>
        ...
        <div className="space-y-4 rounded-lg border border-gray-200 bg-gray-50 p-5">
          <h3 className="text-lg font-semibold text-gray-900">
            3. Furniture and Fittings (Schedule DOA - 17(i))
          </h3>

          <div className="rounded-md border border-gray-300 bg-white p-4">
            <InputField
              label=""
              name="dcgFurnitureAndFittings"
              type="number"
              placeholder="Amount"
              register={register}
              error={errors.dcgFurnitureAndFittings?.message}
            />
          </div>
        </div>
        ...
        <div className="space-y-4 rounded-lg border border-gray-200 bg-gray-50 p-5">
          <h3 className="text-lg font-semibold text-gray-900">
            4. Intangible assets (Schedule DOA - 17(i))
          </h3>

          <div className="rounded-md border border-gray-300 bg-white p-4">
            <InputField
              label=""
              name="dcgIntangibleAssets"
              type="number"
              placeholder="Amount"
              register={register}
              error={errors.dcgIntangibleAssets?.message}
            />
          </div>
        </div>
        ...
        <div className="space-y-4 rounded-lg border border-gray-200 bg-gray-50 p-5">
          ...
          <div className="rounded-md border border-gray-300 bg-white p-4">
            <InputField
              ...
              placeholder="Amount"
              register={register}
              error={errors.dcgShips?.message}
            />
          </div>
        </div>

        {/* Total Deemed Capital Gains Section */}
        <div className="rounded-lg border-2 border-green-300 bg-green-50 p-5">
          ...
          <div className="rounded-md bg-green-100 p-3 text-lg font-bold text-gray-800">
            <div className="flex justify-between">
              <span>Total Deemed Capital Gains:</span>
