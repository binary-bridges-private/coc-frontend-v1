  ...
  const deductionSections = [
    {
      ...
      name: "80C",
      field: "c1_80c",
      note: "(Details are to be filled in the drop down to be provided in e-filing utility)",
    },
    {
      id: "c2",
      name: "80CCC",
    ...
    },
    {
      ...
      name: "80D",
      field: "c6_80d",
      note: "(Details are to be filled in drop down to be provided in e-filing utility)",
    },
    {
      id: "c7",
      name: "80DD",
      field: "c7_80dd",
      note: "(Details to be filled in drop down to be provided in e-filing utility)",
    },
    {
      id: "c8",
      name: "80DDB",
    ...
    },
    {
      ...
      name: "80TTA",
      field: "c16_80tta",
      note: "(Details to be filled in the drop down to be provided in e-filing utility)",
    },
    ...
    <div className="mx-auto max-w-6xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-blue-900">
                Gross Total Income (from Part B)
              </p>
              <p className="text-xs text-blue-700">
                This amount will be used to calculate Taxable Total Income
              </p>
            </div>
            <p className="text-2xl font-bold text-blue-900">
              ₹ {parseFloat(grossTotalIncome || "0").toLocaleString("en-IN")}
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          {(!partAGeneral?.taxRegimeOption ||
            partAGeneral.taxRegimeOption !== "yes-exercised") && (
            <div className="mb-6 rounded-lg border border-yellow-200 bg-yellow-50 p-4">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> You are under the{" "}
                <strong>New Tax Regime</strong>. Most deductions (Section 80C,
                80D, etc.) are not available.
              </p>
              {/* 80CCH and 80CCD(2) might be available, but for simplicity we hide most. 
                   If we want to show specific ones, we can filter the map. 
                   Let's say we hide ALL for now as per "Most deductions... not available".
                   Or better, filtered rendering.
               */}
            </div>
          )}
          ...
          {partAGeneral?.taxRegimeOption === "yes-exercised" ? (
              ...
              {deductionSections.map((section) => (
                ...
                >
                  ...
                  <input
                    type="number"
                    {...register(
                      section.field as keyof PartCDeductionsFormData
                    )}
                    placeholder="0"
            ...
            <div className="text-sm text-gray-500 italic">
              Deductions are disabled in New Tax Regime.
              {/* If we needed to show 80CCD(2), we would render it here explicitly. */}
            </div>
          )}
        </div>
