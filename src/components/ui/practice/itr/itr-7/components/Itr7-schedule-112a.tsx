...
import { ITR7Schedule112AData } from './itr-7-schedule-112a.types.ts';
import { Plus, Trash2 } from 'lucide-react';

export interface Itr7Schedule112AProps {
    form: UseFormReturn<ITR7Schedule112AData>;
}
...
const Itr7Schedule112A: React.FC<Itr7Schedule112AProps> = ({ form }) => {
    const { fields, append, remove } = useFieldArray({
        control: form.control,
        name: "schedule112a.details",
    });

    return (
        <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Schedule 112A</h2>
                            ...
                            {fields.map((field, index) => (
                                <tr key={field.id} className="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td className="px-2 py-1 border">
                                        <SelectInput
                                            name={`schedule112a.details.${index}.share_acquired_date`}
                                            form={form}
                                            options={[
                                    ...
                                    <td className="px-2 py-1 border">
                                        <SelectInput
                                            name={`schedule112a.details.${index}.share_transferred_date`}
                                            form={form}
                                            options={[
                                    ...
                                    <td className="px-2 py-1 border"><TextInput name={`schedule112a.details.${index}.isin_code`} form={form} /></td>
                                    <td className="px-2 py-1 border"><TextInput name={`schedule112a.details.${index}.name_share_unit`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.no_of_shares`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.sale_price_per_share`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.full_value_consideration`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.cost_acquisition_without_indexation`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.cost_acquisition`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.lower_of_11_and_6`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.fair_market_value_per_share`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.total_fair_market_value`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.expenditure_transfer`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.total_deductions`} form={form} /></td>
                                    <td className="px-2 py-1 border"><NumberInput name={`schedule112a.details.${index}.balance`} form={form} /></td>
                ...
                <div className="mt-8 border-t pt-4">
                    <div className="grid grid-cols-1 gap-4">
                        <div className="grid grid-cols-12 gap-4 items-center">
                            ...
                            <div className="col-span-4"><NumberInput name="schedule112a.total_transfer_before_23_july" form={form} /></div>
                        </div>
                        <div className="grid grid-cols-12 gap-4 items-center">
                            <div className="col-span-8 text-sm font-semibold">ii. Total of Col 14 where transfer was on or after 23rd July 2024</div>
                            <div className="col-span-4"><NumberInput name="schedule112a.total_transfer_after_23_july" form={form} /></div>
                        </div>
                        <div className="grid grid-cols-12 gap-4 items-center bg-gray-50 p-2 rounded">
                            <div className="col-span-8 text-sm font-bold">iii. Total of LTCG u/s 112A</div>
                            <div className="col-span-4"><NumberInput name="schedule112a.total_ltcg_112a" form={form} /></div>
                        </div>
                    </div>
                </div>
            </div>
...
export default Itr7Schedule112A;
