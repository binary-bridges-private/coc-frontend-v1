...
import { initialItrTwoFormData, initialItrTwoFormErrors, ITR_TWO_STEPS } from './constants/ItrTwoConstants.ts';
import { validateItrTwoStep, calculateTotalIncome, calculateTotalDeductions, calculateTaxPayable } from './ItrTwoValidation.ts';
import ItrTwoPersonalInfo from './components/ItrTwoPersonalInfo.tsx';
import ItrTwoSalary from './components/ItrTwoSalary.tsx';
import ItrTwoHouseProperty from './components/ItrTwoHouseProperty.tsx';
import ItrTwoCapitalGains from './components/ItrTwoCapitalGains.tsx';
import ItrTwoDeductions from './components/ItrTwoDeductions.tsx';
import ItrTwoForeignAssets from './components/ItrTwoForeignAssets.tsx';
import ItrTwoAssetsLiabilities from './components/ItrTwoAssetsLiabilities.tsx';
import ItrTwoSchedule112A from './components/ItrTwoSchedule112A.tsx';
import ItrTwoSchedule80G from './components/ItrTwoSchedule80G.tsx';
import ItrTwoTotalIncome from './components/ItrTwoTotalIncome.tsx';
import ItrTwoTaxLiability from './components/ItrTwoTaxLiability.tsx';
  ...
  const renderStepContent = () => {
    switch (step) {
      ...
      case 12:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-800">Schedule 115AD - Capital Gains on Foreign Assets</h2>
            <p className="text-sm text-gray-600">Details of capital gains on foreign assets</p>
            {/* Add Schedule 115AD implementation here */}
          </div>
        );
      case 13:
        return (
      ...
      case 14:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-800">Schedule CYLA/BFLA/CFL - Loss Adjustment</h2>
            <p className="text-sm text-gray-600">Current year and brought forward loss adjustments</p>
            {/* Add loss adjustment implementation here */}
          </div>
        );
      case 15:
        return (
      ...
      case 17:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-800">Schedule AMT/AMTC - Alternate Minimum Tax</h2>
            <p className="text-sm text-gray-600">Alternate Minimum Tax computation and credit</p>
            {/* Add AMT implementation here */}
          </div>
        );
      case 18:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-800">Schedule SPI/SI/EI - Special Income</h2>
            <p className="text-sm text-gray-600">Specified persons, special and exempt income</p>
            {/* Add special income implementation here */}
          </div>
        );
      case 19:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-800">Schedule PTI/FSI/TR - Foreign Income</h2>
            <p className="text-sm text-gray-600">Pass-through, foreign source income and tax relief</p>
            {/* Add foreign income implementation here */}
          </div>
        );
      case 20:
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-800">Schedule 5A - Portuguese Civil Code</h2>
            <p className="text-sm text-gray-600">Income apportionment between spouses</p>
            {/* Add Portuguese Civil Code implementation here */}
          </div>
        );
      case 21:
        return (
