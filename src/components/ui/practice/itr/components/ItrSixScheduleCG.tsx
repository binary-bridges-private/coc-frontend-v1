...
interface ItrSixScheduleCGProps {
...
const ItrSixScheduleCG: React.FC<ItrSixScheduleCGProps> = ({
  capitalGainDetails,
  onAddDetail,
  onRemoveDetail,
  onUpdateDetail
  ...
  const calculateTotalExpenses = (detail: CapitalGainDetail) => {
    return detail.stampDuty + detail.registrationCharges + detail.brokerage + detail.otherCharges;
  };
    ...
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => onUpdateDetail(index, 'assetCategory', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
              ...
              <div>
                ...
                <select
                  value={detail.acquisitionMode}
                  onChange={(e) => onUpdateDetail(index, 'acquisitionMode', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
              ...
              <div>
                ...
                <select
                  value={detail.disposalMode}
                  onChange={(e) => onUpdateDetail(index, 'disposalMode', e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  <option value="">Select Disposal Mode</option>
                  {disposalModes.map(mode => (
                    <option key={mode} value={mode}>{mode}</option>
                  ))}
                </select>
              </div>
              ...
              <div>
                ...
                <input
                  type="number"
                  value={detail.fairValue}
                  onChange={(e) => onUpdateDetail(index, 'fairValue', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  type="number"
                  value={detail.considerationReceived}
                  onChange={(e) => onUpdateDetail(index, 'considerationReceived', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Enter consideration received"
                  step="0.01"
                  min="0"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="number"
                  value={detail.considerationPaid}
                  onChange={(e) => onUpdateDetail(index, 'considerationPaid', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  type="number"
                  value={detail.stampDuty}
                  onChange={(e) => onUpdateDetail(index, 'stampDuty', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  type="number"
                  value={detail.registrationCharges}
                  onChange={(e) => onUpdateDetail(index, 'registrationCharges', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  type="number"
                  value={detail.brokerage}
                  onChange={(e) => onUpdateDetail(index, 'brokerage', parseFloat(e.target.value) || 0)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="bg-blue-50 p-6 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-4 rounded-md">
            <h4 className="text-md font-semibold text-gray-700 mb-3">Asset Type Distribution</h4>
            <div className="space-y-2 text-sm">
              {assetTypes.map(type => {
                const count = capitalGainDetails.filter(detail => detail.assetType === type).length;
                if (count > 0) {
                  return (
          ...
          <div className="bg-white p-4 rounded-md">
            <h4 className="text-md font-semibold text-gray-700 mb-3">Acquisition Mode Distribution</h4>
            <div className="space-y-2 text-sm">
              {acquisitionModes.map(mode => {
                const count = capitalGainDetails.filter(detail => detail.acquisitionMode === mode).length;
                if (count > 0) {
                  return (
      ...
      <div className="mt-8 bg-blue-50 p-6 rounded-lg">
        ...
        <div className="space-y-2 text-sm text-blue-700">
          ...
          <p><strong>Market Value:</strong> Fair market value of the asset</p>
          <p><strong>Consideration:</strong> Amount received or paid for the asset</p>
...
export default ItrSixScheduleCG;
