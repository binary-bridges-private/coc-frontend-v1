...
import { ITR_TWO_OPTIONS } from '../constants/ItrTwoConstants';

interface ItrTwoPersonalInfoProps {
  formData: ItrTwoFormData;
  errors: ItrTwoFormErrors;
  handleInputChange: (field: keyof ItrTwoFormData, value: string) => void;
}

const ItrTwoPersonalInfo: React.FC<ItrTwoPersonalInfoProps> = ({
  formData,
  errors,
  handleInputChange
}) => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          />
          {errors.email1 && <p className="mt-1 text-sm text-red-600">{errors.email1}</p>}
        </div>
...
export default ItrTwoPersonalInfo;
