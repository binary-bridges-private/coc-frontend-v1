      ...
      <footer className="container px-4 py-10 mx-auto sm:px-6 lg:px-8 xl:px-20">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div className="space-y-6 lg:pl-4">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li
                  key={item}
                  className="text-sm text-gray-800 transition-colors hover:text-blue-600 sm:text-base"
                >
              ...
              {[
                {
                  ...
                  color: "bg-blue-600",
                  link: "https://www.facebook.com/share/1ATktFboCS/",
                },
                {
                  icon: <FaInstagram className="text-xl" />,
                  color: "bg-pink-600",
                  link: "https://www.instagram.com/cfmcoceducation?igsh=MTN2OXF3Z2ZsdzRnMw==",
                },
                {
                  icon: <FaTelegram className="text-xl" />,
                  color: "bg-blue-400",
                  link: "https://t.me/cfmbycoceducation",
                },
                {
                  icon: <FaYoutube className="text-xl" />,
                  color: "bg-red-600",
                  link: "https://youtube.com/@cfmcoceducation?si=vhRbpsOvVbrh1k5Y",
                },
              ].map((social, index) => (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                {
                  icon: <PiCurrencyInrBold className="text-2xl" />,
                  name: "PayUMoney",
                },
                {
                ...
                {
                  icon: <SiGooglepay className="text-2xl text-blue-500" />,
                  name: "GPay",
                },
                {
                ...
                {
                  icon: <SiRazorpay className="text-2xl text-blue-700" />,
                  name: "Razorpay",
                },
              ].map((payment, index) => (
                <div
        ...
        <div className="pt-6 mt-12 border-t border-gray-200">
          <p className="text-xs text-center text-gray-500 sm:text-sm">
            © {new Date().getFullYear()} COC Education Pvt. Ltd. All rights
            reserved.
          </p>
        </div>
      </footer>
  ...
  return (
    <div className="relative w-full py-10 overflow-hidden bg-gray-500">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-3xl gap-6 px-4 mx-auto text-center">
        ...
        >
          Get exclusive insights, updates, and special offers delivered to your
          inbox
        </motion.p>
